  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        ...props,
        children: loading ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-4 w-4 animate-spin rounded-full border-2 border-current/30 border-t-current" }) : children
      }
    );
  }
);
...
var Input = react.forwardRef(function Input2({ className, isInvalid = false, ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "input",
    {
      ref,
...
function Card({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        background,
        variant === "glass" && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute inset-0 pointer-events-none border border-white/5 dark:border-white/[0.02] rounded-xl" }),
        (title || action) && /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            className: clsx7__default.default(
              "relative z-10 flex items-center justify-between",
              padding === "none" ? "px-5 pt-5 pb-2" : clsx7__default.default(paddingClasses[padding], "pb-2")
            ),
            children: [
...
function Modal({
  ...
  const modalContent = /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxRuntime.jsxs(
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          framerMotion.motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sm:hidden flex items-center justify-center pt-2", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-1.5 w-12 rounded-full bg-[var(--color-border)]" }) }),
              (title || description) && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mb-3", children: [
                title && /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-base font-semibold text-[var(--color-fg)]", children: title }),
                description && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mt-1 text-sm text-[var(--color-muted)]", children: description })
              ] }),
              children,
              footer && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mt-4 flex items-center justify-end gap-2", children: footer })
            ]
          }
        )
      ]
...
function Drawer({
  ...
  const drawerContent = /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxRuntime.jsxs(
    framerMotion.motion.div,
    {
      className: clsx7__default.default(
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          framerMotion.motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sm:hidden flex items-center justify-center pt-3 pb-1 flex-none bg-[var(--color-content-bg)] z-30", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-1.5 w-12 rounded-full bg-[var(--color-border)]" }) }),
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: "px-4 py-3 border-b border-[var(--color-border)]/50 flex-none bg-[var(--color-content-bg)] z-20", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [
                showBackButton && /* @__PURE__ */ jsxRuntime.jsx(
                  "button",
                  {
                    onClick: onBack,
                    ...
                    "aria-label": "Go back",
                    children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ChevronLeft, { className: "h-4 w-4 text-[var(--color-fg)]" })
                  }
                ),
                (displayTitle || displayDescription) && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1", children: [
                  displayTitle && /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-base font-normal text-[var(--color-fg)]", children: displayTitle }),
                  displayDescription && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mt-1 text-sm text-[var(--color-muted)]", children: displayDescription })
                ] })
              ] }) }),
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex-1 min-h-0 overflow-y-auto", children: /* @__PURE__ */ jsxRuntime.jsx(
                framerMotion.motion.div,
                {
                  ...
                  className: clsx7__default.default("h-full", currentView?.noPadding ? "" : "px-4 pb-4"),
                  children: displayContent
                },
                currentViewId || "default"
              ) }),
              footer && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "p-4 border-t border-[var(--color-border)]/50 flex-none bg-[var(--color-content-bg)] z-20", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-center justify-end gap-2", children: footer }) })
            ]
          }
        )
      ]
...
function Dropdown({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { ref: dropdownRef, className: clsx7__default.default("relative", className), children: [
    trigger ? /* @__PURE__ */ jsxRuntime.jsx("div", { onClick: () => setIsOpen(!isOpen), className: "cursor-pointer", children: trigger }) : /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        ref: triggerRef,
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { children: label || "Options" }),
          /* @__PURE__ */ jsxRuntime.jsx(
    ...
    isOpen && /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "py-1 overflow-y-auto", style: { maxHeight: `${maxHeight}px` }, children: items.map((item, index) => /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            onClick: () => {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex items-center gap-2 whitespace-nowrap", children: [
                item.icon && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "flex-shrink-0", children: item.icon }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { children: item.label })
              ] }),
              item.selected && /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Check, { size: 12, className: "text-[var(--color-accent)] flex-shrink-0" })
            ]
          },
          index
        )) })
...
function ConfirmDialog({
  ...
  const meetsRequirement = react.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Modal_default, { isOpen, onClose: onCancel, children: /* @__PURE__ */ jsxRuntime.jsxs(
    "form",
    {
      className: "relative",
      onSubmit: (e) => {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "pr-8 text-lg font-semibold text-[var(--color-fg)]", children: title }),
        variant === "danger" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-3 flex items-center gap-2 rounded-md border border-[color-mix(in_oklab,var(--color-danger),transparent_70%)] bg-[color-mix(in_oklab,var(--color-danger),transparent_90%)] px-3 py-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            "svg",
            {
              width: "16",
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm font-medium", children: "This action cannot be undone." })
        ] }),
        description && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mt-3 text-sm text-[var(--color-muted)]", children: description }),
        requiredText && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-4", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("label", { className: "block text-sm font-medium", children: [
            "Type",
            " ",
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-5 flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            Button_default,
            {
              type: "button",
...
function EmptyStateRoot({ children, className }) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    framerMotion.motion.div,
    {
      ...
      className: clsx7__default.default("relative", className),
      children
    }
  );
}
function Hero({
  ...
  if (layout === "split" && preview) {
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute inset-0 pointer-events-none", children: /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute top-0 left-0 w-16 h-1 bg-gradient-to-r from-[var(--color-accent)] to-transparent rounded-full" }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative flex-1 max-w-xs", children: [
            icon && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative mb-6 w-fit", children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-14 h-14 rounded-2xl bg-gradient-to-br from-[var(--color-accent)]/20 to-[var(--color-accent)]/5 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-[var(--color-accent)] [&>svg]:w-7 [&>svg]:h-7", children: icon }) }),
              badge && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute -top-1 -right-1 w-6 h-6 rounded-full bg-[var(--color-accent)] flex items-center justify-center text-white [&>svg]:w-3 [&>svg]:h-3", children: badge })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "text-3xl sm:text-4xl font-semibold text-[var(--color-fg)] mb-4 tracking-tight leading-tight", children: title }),
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-base text-[var(--color-muted)] mb-8 leading-relaxed", children: description }),
            action
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative flex-1 w-full lg:w-auto", children: preview })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        icon && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative mb-6", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-20 h-20 rounded-full bg-gradient-to-br from-[var(--color-accent)]/20 to-[var(--color-accent)]/5 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-[var(--color-accent)] [&>svg]:w-10 [&>svg]:h-10", children: icon }) }),
          badge && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute -top-1 -right-1 w-8 h-8 rounded-full bg-[var(--color-accent)] flex items-center justify-center text-white [&>svg]:w-4 [&>svg]:h-4", children: badge })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "text-2xl font-semibold text-[var(--color-fg)] mb-2 text-center", children: title }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[var(--color-muted)] text-center max-w-md mb-8", children: description }),
        action
      ]
    }
  );
...
function Feature({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: clsx7__default.default("text-center", className), children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        className: "w-10 h-10 rounded-lg bg-[var(--color-surface)] flex items-center justify-center mx-auto mb-3",
        style: { color: iconColor },
        children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "[&>svg]:w-5 [&>svg]:h-5", children: icon })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-sm font-medium text-[var(--color-fg)] mb-1", children: title }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs text-[var(--color-muted)]", children: description })
  ] });
}
function Preview({ children, className }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: clsx7__default.default("relative", className), children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[var(--color-bg)] pointer-events-none z-10" }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "space-y-4 opacity-60", children })
  ] });
}
function MockCard({
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-4 w-24 bg-[var(--color-muted)]/20 rounded" }) })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-4 w-16 bg-[var(--color-muted)]/20 rounded" })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-2 w-full bg-[var(--color-muted)]/10 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex justify-between mt-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-3 w-12 bg-[var(--color-muted)]/15 rounded" }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-3 w-12 bg-[var(--color-muted)]/15 rounded" })
        ] })
      ]
    }
